...
/**
 * 表名：tb_his_zy_fee_detail_fs(住院费用发生明细表) 
 */
@ApiModel(value = "住院费用发生明细表")
@TableName("tb_his_zy_fee_detail_fs")
public class TbHisZyFeeDetailFs extends Model<TbHisZyFeeDetailFs> implements Serializable {
	...
	public void setFyfssj(String fyfssj) {
		this.fyfssj = fyfssj;
	}
