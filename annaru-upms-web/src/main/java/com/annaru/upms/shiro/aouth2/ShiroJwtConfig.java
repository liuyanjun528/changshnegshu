package com.annaru.upms.shiro.aouth2;

import com.annaru.upms.shiro.cache.RedisCacheManager;
import com.annaru.upms.shiro.cache.RedisSessionDAO;
 ...
 */
@Configuration
@ConditionalOnProperty(value = "upms.security.type", matchIfMissing = false)
public class ShiroJwtConfig {
    ...
    public SessionManager sessionManager() {
        ...
        sessionManager.getSessionIdCookie().setPath("/annaru-dubbo");
