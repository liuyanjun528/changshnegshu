...
import com.annaru.upms.mapper.SysRoleMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService {
    ...
    @Override
    public RoleVo selectByUserId(String userId) {
        return this.baseMapper.selectByUserId(userId);
    }

    @Override
    public RoleVo selectByRoleId(String roleId) {
    ...
    private void checkPrems(SysRole role){
        ...
        //查询用户所拥有的菜单列表
        List<String> resourceIdList=sysUserService.selectResourceIdListByUserId(role.getCreateUserId());
        //判断是否越权
